...
def profile_all_inter_BSA(args, exp_config: Evaluation_Configs, da_config: Dist_Attn_Config, ncclcomm_global, gloo_global_group, \
    ...
    for key in keys:
        ...
        inter_comp_plans_dict = prepare_inter_comp_plans(inter_bsa_execution_plan, prof_db)     
...
def step4_profile_inter_bsa_exe_plans(inter_exp_da_configs, ncclcomm_global, gloo_global_group, prof_db):
