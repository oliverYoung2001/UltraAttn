...
def plot_strong_scalability_for_inference(raw_time_dict: dict):
    ...
    figsize = {
        ...
        "figure.figsize": (20,20),  # Column, Row
    ...
    num_figs_per_row = len(Nhs) * len(BSA_reprs) # For cherry pick
    num_figs = num_figs_per_row * len(Ss)
    ...
    fig.savefig(f"./plot/figs/strong_scalability_inference.pdf", bbox_inches='tight')
