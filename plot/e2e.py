...
def plot_e2e(raw_time_dict):
    ...
    fig.legend(handles=legend_handles, loc='upper center', ncol=len(full_sys_names), bbox_to_anchor=(0.5, 1.15))
    # fig.text(0.085, 0.5, 'Relative Performance', va='center', rotation='vertical', fontsize=10)
    plt.subplots_adjust(hspace=0.2,wspace=0.05)
    fig.savefig(f"./plot/figs/e2e.pdf", bbox_inches='tight')
